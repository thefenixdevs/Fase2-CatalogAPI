...
public sealed class ProcessPaymentEventConsumer : IConsumer<PaymentProcessedEvent>
{
    ...
    public async Task Consume(ConsumeContext<PaymentProcessedEvent> context)
    {
        ...
        _logger.LogInformation("Processing PaymentProcessedEvent. OrderId: {OrderId}, Status: {Status}, UserId: {UserId}, GameId: {GameId}",
            message.OrderId, message.Status, message.UserId, message.GameId);
        ...
        _logger.LogInformation("Payment processed successfully. OrderId: {OrderId}, OrderStatus: {OrderStatus}, GameId: {GameId}, UserId: {UserId}",
            message.OrderId, order.Status, message.GameId, message.UserId);
    }
}
